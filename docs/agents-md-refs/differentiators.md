...
**Reference from AGENTS.md:** When the user asks "why this workflow?" or
"how is this different from X?", point here. When adding a new stage or
skill, check that it reinforces at least one differentiator (not redundant
with existing ones).
